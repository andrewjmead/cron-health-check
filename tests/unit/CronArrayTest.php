 ...
 * Cron array tests.
 */
final class CronArrayTest extends SPCR_Unit_TestCase {
	...
	public function test_flatten_produces_rows() {
		...
		$rows = SPCR_Cron_Health_Check::flatten_cron_array( $this->fixture(), 3000 );
	...
	public function test_flatten_sorts_by_timestamp() {
		...
		$rows = SPCR_Cron_Health_Check::flatten_cron_array( $cron, 6000 );
	...
	public function test_version_key_skipped() {
		...
		$rows = SPCR_Cron_Health_Check::flatten_cron_array( $cron, 1000 );
	...
	public function test_partition_grace_boundary() {
		...
		$parts = SPCR_Cron_Health_Check::partition_overdue( $rows, $now, 60 );
